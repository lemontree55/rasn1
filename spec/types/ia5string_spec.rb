  ...
  describe IA5String do
    ...
    describe '#to_der' do
      ...
      it 'generates a DER string according to optional' do
        ia5 = IA5String.new(:ia5, optional: true)
        ia5.value = nil
        expect(ia5.to_der).to eq('')
        ia5.value = 'abc'
